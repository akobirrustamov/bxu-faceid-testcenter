    ...
    return (
        <div className="h-full">
            ...
            >
                            ...
                            <div className="col-lg-12 col-md-12 col-12">
                                <div className="content">
                                    ...
                                    <p className="text-white text-center">
                                        ...
                                        tomonidan 2021-yil 29-oktabr kuni 0037-raqamli litsenziya Buxoro psixologiya va
                                        xorijiy tillar institutiga oliy ta’lim xizmatlarini ko’rsatish uchun va
                                        O‘zbekiston Respublikasi oliy ta’lim, fan va innovatsiyalar vazirligi tomonidan
                                        2024-yil 16-maydan 277162-raqamli litsenziya bilan yangi yo‘nalishlarga ruxsat
                                        berilgan
                                    </p>
                ...
                <section className="overlay bg-black bg-opacity-50 pt-4" data-stellar-background-ratio="0.5">
